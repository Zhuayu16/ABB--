...
<title>梯网化焊接修复参数优化系统 - 技术深度解析</title>
...
.architecture-diagram .subgraph {
    border: 1px dashed #888;
    padding: 10px;
    margin-bottom: 10px;
    border-radius: 4px;
    }
.architecture-diagram .subgraph-title {
    font-weight: bold;
    margin-bottom: 10px;
    text-align: center;
    }
...
<script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const ctxTrend = document.getElementById('qualityTrendChart');
            if (ctxTrend) {
                new Chart(ctxTrend, {
                    type: 'line',
                    data: {
                        labels: Array.from({ length: 20 }, (_, i) => {
                            const d = new Date(Date.now() - (19 - i) * 1000);
                            return d.toTimeString().split(' ')[0];
                        }),
                        datasets: [{
                            label: '质量评分',
                            data: Array.from({ length: 20 }, () => 75 + Math.random() * 20 - 10),
                            borderColor: '#007bff',
            ...
            // 2. Optimization Compare Chart
            const ctxCompare = document.getElementById('optimizationCompareChart');
            if (ctxCompare) {
					...
					<div class="reference-list">
						...
						<div class="reference-item">
							...
							<div class="reference-content">
								<p class="reference-text">[PDF] Application of Welding Process Parameters Using AI Algorithm</p>
								<a href="https://turcomat.org/index.php/turkbilmat/article/download/13866/10031/24873" class="reference-link" target="_blank">https://turcomat.org/index.php/turkbilmat/article/download/13866/10031/24873</a>
							</div>
						</div>
						...
						<div class="reference-item">
							...
							<div class="reference-content">
								<p class="reference-text">Welding in 2024: Innovations and Trends</p>
								<a href="https://arcweldingservices.co.uk/welding-in-2024-innovations-and-trends/" class="reference-link" target="_blank">https://arcweldingservices.co.uk/welding-in-2024-innovations-and-trends/</a>
							</div>
						</div>
